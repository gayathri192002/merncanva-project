...
const Curentcomponent = ({ info, current_component,removeComponent}) => {
    //  console.log(info)
            ...
            >
                ...
                {current_component.id === info.id && (
                    <div 
                        ...
                        className='px-3 py-2 bg-white absolute top-[-40px] left-[50%] translate-x-[-50%] shadow-md cursor-pointer rounded-md hidden group-hover:block'
                    >
                        <FaTrashAlt />
                    </div>
                )}
...
export default Curentcomponent